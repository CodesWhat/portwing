...
filetext|Structured Audit Log|Portwing writes a tamper-evident JSON audit log for every proxied Docker API call. Hawser has no built-in audit trail.
...
`,
  ...
  metadataDescription:
    "Compare Hawser (Dockhand agent) and Portwing. Both are lightweight Go remote Docker agents with outbound edge tunnels. See how Portwing adds Ed25519 auth, a tamper-evident audit log, signed images, and an MCP server.",
  metadataKeywords: [
    "hawser vs portwing",
    "hawser alternative",
  ...
  openGraphDescription:
    "Hawser and Portwing are both lightweight Go remote Docker agents with outbound edge modes. See how Portwing adds Ed25519 auth, a tamper-evident audit log, signed images, and an MCP server.",
  twitterDescription:
