...
`,
  ...
  metadataDescription: `Compare Hawser v0.2.46 and Portwing v${SITE_CONFIG.version}. Both are lightweight Go Docker proxies with standard and edge modes; compare auth, socket policy, auditing, metrics, and release evidence.`,
  metadataKeywords: [
    "hawser vs portwing",
    "hawser alternative",
  ...
  twitterDescription: `Hawser v0.2.46 vs Portwing v${SITE_CONFIG.version}: two close Go agent peers compared without stale marketing claims.`,
  ...
  heroDescription: (
    <p>
      ...
      outbound edge transport. Portwing v{SITE_CONFIG.version} adds{" "}
  ...
  jsonLdDescription: `Evidence-backed comparison of Hawser v0.2.46 and Portwing v${SITE_CONFIG.version} for remote Docker access.`,
