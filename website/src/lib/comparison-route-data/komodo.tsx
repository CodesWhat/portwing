...
`,
  ...
  metadataDescription: `Compare Komodo Periphery v2.3.2 and Portwing v${SITE_CONFIG.version} across outbound agents, public-key authentication, Docker API compatibility, socket policy, audit, metrics, and product scope.`,
  metadataKeywords: [
  ...
  twitterDescription: `Komodo Periphery v2.3.2 vs Portwing v${SITE_CONFIG.version}: outbound transport, key auth, audit, and socket containment.`,
  competitorName: "Komodo",
  heroTitle: "Komodo vs Portwing",
  heroDescription: (
    <p>
      Komodo v2.3.2 is a full build, deployment, automation, and Swarm platform. Its Periphery agent
      ...
      . Komodo is production-mature; Portwing v0.9.x is a supported pre-v1 release. Reviewed August
      29, 2026.
    </p>
  ),
  ...
  jsonLdDescription: `Evidence-backed comparison of Komodo Periphery v2.3.2 and Portwing v${SITE_CONFIG.version} for remote Docker access.`,
