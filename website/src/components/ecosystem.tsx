...
// Ecosystem = CodesWhat family lineup — Portwing (current), Drydock, Sockguard.
...
const PROJECTS: Project[] = [
  {
    name: "Drydock",
    tagline: "Container update manager — orchestrates across your hosts",
    light: "/drydock-logo.png",
    dark: null,
  ...
  {
    name: "Sockguard",
    tagline: "Default-deny Docker socket firewall",
