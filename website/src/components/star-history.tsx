...
function StarChart({ className }: { className?: string }) {
  return (
    <a href={CHART_HREF} target="_blank" rel="noopener" className={className}>
      ...
      {/* biome-ignore lint/performance/noImgElement: external SVG from star-history.com; next/image requires remotePatterns config for this domain */}
  ...
  return (
    <section className="border-t border-border/60 py-16">
      <div className="mx-auto max-w-4xl px-4">
        ...
        <StarChart className="block overflow-hidden rounded-2xl border border-neutral-200 bg-white/50 backdrop-blur-sm transition-all duration-300 hover:border-violet-200 hover:shadow-lg dark:border-neutral-800 dark:bg-neutral-900/50 dark:hover:border-violet-800" />
