      ...
      <div className="relative flex w-4 shrink-0 flex-col items-center">
        ...
        <div
          className={`relative z-10 mt-1 flex h-3 w-3 shrink-0 items-center justify-center rounded-full border-2 ${
            isHead
              ? "border-violet-400 bg-violet-400 ring-2 ring-violet-400/40 ring-offset-1 dark:ring-offset-neutral-950"
              : isReleased
    ...
    <section className="border-t border-border/60 py-16">
      <div className="mx-auto max-w-3xl px-4">
        <SectionHeading
          ...
          title="Roadmap"
          subtitle="Where we've been and where we're headed. Direction, not commitments."
          align="right"
        />
        ...
        <div className="mb-4 flex flex-wrap items-center justify-end gap-x-5 gap-y-1.5 text-[11px] text-neutral-500 dark:text-neutral-400">
          ...
          <span className="flex items-center gap-1.5">
            <span className="h-2 w-2 rounded-full bg-violet-400 ring-2 ring-violet-400/40" />
            Current (HEAD)
          </span>
          <span className="flex items-center gap-1.5">
