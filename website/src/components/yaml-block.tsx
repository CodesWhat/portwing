...
// Portwing violet palette — violet keys, fuchsia/indigo values, muted comments.
const KEY = "text-violet-400"; // YAML keys
const VAL = "text-fuchsia-400"; // image refs, quoted strings, numbers, booleans
 ...
 * Tokenizes per-line: keys → violet, image/path/number/boolean values → fuchsia,
