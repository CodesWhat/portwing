...
- **Resource limits**: WebSocket read (16 MB), response body (100 MB), exec body (10 MB), signed-request body (1 MB), enrollment body (64 KiB), concurrent sessions (100), cold Argon2 derivations (2), nonce LRU (10,000).
