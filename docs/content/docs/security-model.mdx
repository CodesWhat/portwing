...
<Callout type="info">
Portwing v0.8.x is a supported pre-v1 release. The controls documented here are implemented and tested, and public interfaces follow the published [stability policy](https://github.com/CodesWhat/portwing/blob/main/STABILITY.md). This page describes the product's security model; it is not a compliance certification or substitute for your own threat model.
</Callout>
