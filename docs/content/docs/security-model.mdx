...
- **SLSA provenance** — GitHub build provenance covers every asset listed in `checksums.txt`, including archives, packages, and per-archive SBOMs, plus the container manifest.
