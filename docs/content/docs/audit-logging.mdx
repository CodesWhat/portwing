...
<Callout type="warn">
  The audit event schema is marked stable in `internal/audit/audit.go`, but Portwing is currently in v0.2.x alpha. Field additions are non-breaking; field renames or removals will be announced in the changelog before they ship.
</Callout>
...
```json
{"time":"2026-01-15T10:23:50.001000000Z","level":"INFO","msg":"","event":"auth_failure","actor":"203.0.113.9","method":"GET","path":"/_portwing/health","outcome":"denied"}
```
