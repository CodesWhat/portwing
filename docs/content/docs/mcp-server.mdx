...
<Callout type="info">
The MCP server is supported in Portwing v0.8.x. Its tool names, input schemas, and result shapes follow the repository's published pre-v1 stability policy.
</Callout>
