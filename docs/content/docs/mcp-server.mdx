...
<Callout type="warn">
The MCP server is available in Portwing v0.6.x (currently alpha). The tool surface is stable, but the endpoint should be treated as experimental until v1.0.
</Callout>
