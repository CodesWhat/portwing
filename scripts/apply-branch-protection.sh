#!/usr/bin/env bash
# Apply (or update) the "Main branch protection" ruleset on the lookout repo.
#
...
#
# Usage:
#   bash scripts/apply-branch-protection.sh            # CodesWhat/lookout
#   REPO=owner/name bash scripts/apply-branch-protection.sh
set -euo pipefail

REPO="${REPO:-CodesWhat/lookout}"
